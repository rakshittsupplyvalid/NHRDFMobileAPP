...
const styles = StyleSheet.create({
  ...
  signaturePreviewContainer: { flex: 1, justifyContent: 'center', alignItems: 'center' },
  previewTitle: { fontSize: 18, marginBottom: 20 },
  signatureImage: { width: '100%', height: 200, marginBottom: 20, borderWidth: 1, borderColor: '#ccc' },
});
